...
def parse_args():
    ...
    parser.add_argument('-c',
                        '--config',
                        type=str,
                        default='../configs/recognition/pptsn/pptsn_k400_videos.yaml',
                        help='config file path')
    parser.add_argument("-i", "--input_file", type=str, help="input file path")
    parser.add_argument("--model_file", type=str, default='../inference/ppTSN/ppTSN.pdmodel')
    parser.add_argument("--params_file", type=str, default='../inference/ppTSN/ppTSN.pdiparams')
...
def hands_predict(input_file:str):
    """
    魔改
    """
    args = parse_args()
    ...
    if not args.enable_benchmark:
        ...
        # Post process output
        result=InferenceHelper.postprocess(output)
...
#     input_file='./video/zhua49.mp4'
#     h=hands_prediect(input_file)
#     print(h)
